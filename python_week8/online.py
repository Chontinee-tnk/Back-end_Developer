import onlinestore
mycursor = onlinestore.mydb.cursor() #เก็บการทำงานของsql
...
def start():
    while True:
        print("\nเมนูหลัก:")
        user_input = input("กรุณาพิมพ์คำว่า 'users', 'products', 'categories', 'orders' หรือ 'close' เพื่อจบการทำงานทั้งหมด: ")
        ...
        if user_input == "users":
            ...
            print("กรุณาพิมพ์คำสั่งที่ถูกต้อง เช่น 'users', 'products', 'categories', 'orders' หรือ 'close'")
